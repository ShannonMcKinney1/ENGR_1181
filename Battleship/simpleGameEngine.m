...
classdef simpleGameEngine < handle
    ...
    methods
        function obj = simpleGameEngine(sprites_fname, sprite_width, sprite_height, zoom, background_color)
            % simpleGameEngine
            % Input: 
        ...
        function drawScene(obj, background_sprites, foreground_sprites)
            ...
            for tile_row=1:num_rows
                for tile_col=1:num_cols
                    ...
                    % background color
                    tile_data = zeros(obj.sprite_height,obj.sprite_height,3,'uint8');
                    for rgb_idx = 1:3
